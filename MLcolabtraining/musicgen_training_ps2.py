...
# MusicGen Fine-Tuning - PS2 Soundfont

Fine-tuning MusicGen on PS2 (PlayStation 2) audio dataset.
...
PS2_DIR = DATA_DIR / 'ps2'
PS2_ARCHIVE = PS2_DIR / "ps2_audio.tar.gz"

print("="*60)
print("PS2 DATASET SETUP")
print("="*60)
print("\nOptions:")
...
for epoch in range(TRAINING_CONFIG['num_epochs']):
    ...
    if val_loss < best_val_loss:
        ...
        best_model_path = CHECKPOINT_DIR / "best_model_ps2.pt"
        torch.save({
            'epoch': epoch + 1,
            'model_state_dict': lm.state_dict(),
            'val_loss': val_loss,
...
best_checkpoint = torch.load(CHECKPOINT_DIR / "best_model_ps2.pt", map_location=device)
...
print(f"\nTraining:")
print(f"  - Dataset: PS2 ({len(train_dataset)} samples)")
