...
# MusicGen Fine-Tuning - SNES Soundfont

Fine-tuning MusicGen on SNES (Super Nintendo) audio dataset.
...
# Rename original to SNES-specific
SNES_DIR = DATA_DIR / 'snes'
SNES_ARCHIVE = SNES_DIR / "snes_audio.tar.gz"

print("="*60)
print("SNES DATASET SETUP")
print("="*60)
print("\nOptions:")
...
for epoch in range(TRAINING_CONFIG['num_epochs']):
    ...
    if val_loss < best_val_loss:
        ...
        best_model_path = CHECKPOINT_DIR / "best_model_snes.pt"
        torch.save({
            'epoch': epoch + 1,
            'model_state_dict': lm.state_dict(),
            'val_loss': val_loss,
...
best_checkpoint = torch.load(CHECKPOINT_DIR / "best_model_snes.pt", map_location=device)
...
print(f"\nTraining:")
print(f"  - Dataset: SNES ({len(train_dataset)} samples)")
