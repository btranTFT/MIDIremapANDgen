...
# MusicGen Fine-Tuning - NDS Soundfont

Fine-tuning MusicGen on NDS (Nintendo DS) audio dataset.
...
best_checkpoint = torch.load(CHECKPOINT_DIR / "best_model_nds.pt", map_location=device)
...
print(f"\nTraining:")
print(f"  - Dataset: NDS ({len(train_dataset)} samples)")
